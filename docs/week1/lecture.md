...
| 구분 | 이번 수업의 표현 | 의미 |
|---|---|---|
| 원본 프로젝트 | `bdai13-bigquery` | 강사가 공유하는 데이터가 있는 위치 |
...
원본 주소는 `bdai13-bigquery.tabformer`입니다. [접속 준비](../setup.md)에서 공유 권한과 데이터 위치를 확인합니다. 원본의 소유 프로젝트와 쿼리를 실행하는 프로젝트가 다를 수 있다는 점을 기억합니다.
