...
교과목 범위와 일정은 제공된 「BDAI 13기 강의계획서 프로젝트분반 조은정 Final」을 따릅니다. 6주차 도구는 사용자의 추가 지시에 따라 Streamlit으로 변경했습니다. 설명·작은 데이터 표·연습 문제는 수업을 위한 확장 자료이며, 실제 데이터에서 실행한 결과와 구분합니다.
