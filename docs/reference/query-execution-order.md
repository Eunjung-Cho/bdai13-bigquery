...
5주차에서 배우는 **뷰와 데이터 마트**도 결국 이 불편함을 없애기 위한 장치입니다.
...
`silver_transactions`는 [5주차 실습](../week5/lab.md)의 선택 실습에서 내 프로젝트에 만드는 정제 거래 테이블입니다. 아직 만들지 않았다면 읽기만 해도 됩니다.
...
FROM `YOUR_PROJECT.bdai13.silver_transactions` AS c
